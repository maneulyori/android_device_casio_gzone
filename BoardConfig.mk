...
-include device/casio/qcom-common/BoardConfigCommon.mk

LOCAL_PATH := device/casio/gzone
...
TARGET_LIBINIT_DEFINES_FILE := device/casio/gzone/init/init_moto_msm8960.c

# Inline kernel building
TARGET_KERNEL_SOURCE := kernel/casio/gzone
TARGET_KERNEL_CONFIG := gzone_defconfig
#TARGET_KERNEL_SELINUX_CONFIG := gzone_defconfig
...
BOARD_USERDATAIMAGE_PARTITION_SIZE := 11643528000
...
TARGET_RELEASETOOLS_EXTENSIONS := device/casio/gzone

# Assert
TARGET_OTA_ASSERT_DEVICE := gzone
...
# TWRP
TW_BOARD_CUSTOM_GRAPHICS := ../../../$(LOCAL_PATH)/tw_graphics.c
